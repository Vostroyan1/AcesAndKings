...
public class WasteController extends SolitaireReleasedAdapter {

	protected PileView src; //PileView of Interest
	
	public WasteController(AcesAndKings theGame, PileView src) {
		super(theGame);
		this.src = src;
	}
	...
	public void mousePressed(MouseEvent me) {
		...
		if (w != Container.getNothingBeingDragged()) {
			System.err.println ("WasteController::mousePressed(): Unexpectedly encountered a Dragging Object during a Mouse press.");
			return;
		}
